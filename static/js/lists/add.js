...
function showListTab(tab) {
  ...
  // 1. Detect likely column indexes from headers
function detectColumns(headers) {
  ...
  // 2. Once user clicks "Upload & Import CSV"
  ...
  // 4. After user confirms mapping, read rows into your list
